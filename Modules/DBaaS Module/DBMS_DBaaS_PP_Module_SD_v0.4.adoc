...
| V3 → V1, V2
| Revocation induced at the evaluator's external KMS (V3); denial of data access observed at the database interfaces (V1); enforcement-state transition and its audit record observed at the service console or audit views (V2).
