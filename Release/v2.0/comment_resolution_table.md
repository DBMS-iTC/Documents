...
| 10 | cPP p.22 | "Refinement: and any identified groups" | Added group association language to FAU_GEN.2.1. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:611`, `:613` |
| 11 | cPP p.22 | "Refinement: [selection: \"user\", \"user and group\"]" | Added `[selection: user, user and group]` to FAU_GEN.2.1. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:613` |
| 12 | cPP p.22 | Highlighted `user identity` in FAU_SEL.1.1. | Made the mandatory `user identity` attribute bold to show the DBMS refinement. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:626` |
| 13 | cPP p.22 | "Refinement: Crossed out, bold text" on FAU_SEL.1.1. | Retained `user identity` in the selection list as bold, crossed-out text because it is now the mandatory first bullet. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:627` |
| 14 | cPP p.22 | Highlighted FDP_ACC.1.1 text "all subjects, all DBMS-controlled objects, and all operations among them." | Treated as context for assignment operation comment. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:643`, `:645` |
| 15 | cPP p.22 | "Assignment: [all subjects, all DBMS-controlled objects, and all operations among them]" | Restored the `assignment:` operation designator for the FDP_ACC.1.1 completed assignments and audited other SFRs for the same overnormalization pattern. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:645`; related cleanup at `:526`, `:527`, `:534`, `:656`, `:739`, `:748`, `:757`, `:763`, `:774`, `:785`, `:798`, `:813`, `:826` |
| 16 | cPP p.25 | Highlighted `the [` in FMT_MSA.3.2. | Treated as context for the next sticky note. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:761`, `:763` |
| 17 | cPP p.25 | "Refinement: Crossed out, bold text" on FMT_MSA.3.2. | Marked deleted `the` before `[no user]` as bold, crossed-out text. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:763` |
| 18 | cPP p.25 | "(Users)" near FMT_REV.1(1). | Changed the title to `FMT_REV.1(1) Revocation (Users)`. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:780`; SD aligned at `Documents/SD/DBMS_SD-working_copy.adoc:342` |
| 19 | cPP p.25 | Highlighted `(DAC)` near FMT_REV.1(2). | Treated as context for the object-label comment. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:793` |
| 20 | cPP p.25 | "(Objects)" near FMT_REV.1(2). | Changed the title to `FMT_REV.1(2) Revocation (Objects)`. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:793`; SD aligned at `Documents/SD/DBMS_SD-working_copy.adoc:364` |
| 21 | cPP p.26 | `[assignment: any additional security management functions required to configure the claimed security]` | Restored the outer `assignment:` designator for the FMT_SMF.1.1 management-function list and retained the nested additional-functions assignment. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:813` |
| 22 | cPP p.34 | "Should be more like FIA_USB_EXT" on FTA_MCS_EXT component leveling. | Reworked the FTA_MCS_EXT component leveling text/diagram to follow the family-to-component style used by FIA_USB_EXT and added hierarchy text. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:1125` |
| 23 | cPP p.34 | Highlighted `FIA_UID.1` dependency. | Treated as context for the next sticky note. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:1155` |
| 24 | cPP p.34 | "Should it be FIA_UID.2 because it is exact conformance?" | Changed the FTA_MCS_EXT dependency in the extended component definition and dependency rationale from FIA_UID.1 to FIA_UID.2. | Fixed | `Documents/cPP/DBMS_cPP-working_copy.adoc:1164`; rationale at `:1564` |
