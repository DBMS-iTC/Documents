...
* user identity;
* [selection: object identity, subject identity, host identity, group identity, event type, success of auditable security events, failure of auditable security events];
