...
.FMT_MSA.1.1(1) – Users  
The TSF shall enforce the [*Discretionary Access Control policy*] to restrict the ability to *[manage]* the security attributes associated with [*users*] to [*authorized administrator*]s.
